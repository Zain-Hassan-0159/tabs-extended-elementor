 ...
 * @since 1.0.0
 */
class Widget_Text_Editor_extended extends \Elementor\Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Text Editor Extended', 'elementor' );
	}
	...
	protected function register_controls() {
		...
		$this->add_group_control(
			...
			[
                ...
                'label' => esc_html__( 'Link Typography', 'elementor' ),
				'global' => [
					'default' => \Elementor\Core\Kits\Documents\Tabs\Global_Typography::TYPOGRAPHY_TEXT,
				],
                'selector' => '{{WRAPPER}} a',
        ...
        $this->add_control(
			'margin_Text',
			[
				'label' => esc_html__( 'Margin Control', 'elementor' ),
				'type' => \Elementor\Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', '%', 'em', 'rem', 'custom' ],
                'default' => [0, 0, 0, 0, 'px', true],
				'selectors' => [
